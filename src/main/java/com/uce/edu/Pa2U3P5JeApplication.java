...
public class Pa2U3P5JeApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		/*
		 * Factura fact1 = this.iFacturaService.buscarPorNumero("001-02569"); for
		 * (DetalleFactura det : fact1.getDetalleFactura()) {
		...
		/////////////////////////////////////////////////
		System.out.println("DEBER JOINS");
		List<Hotel> lista = this.hotelService.buscarHabitacionesInnerJoin("vip");
		for (Hotel f : lista) {
			System.out.println("////////////////////");
			System.out.println(f);
		}
...
/////////////////////////////////////////////////
		...
		List<Hotel> lista2 = this.hotelService.buscarHabitacionesRightJoin("normal");
		for (Hotel f : lista2) {
			System.out.println("////////////////////");
			System.out.println(f);
		}
...
/////////////////////////////////////////////////
		...
		List<Hotel> lista3 = this.hotelService.buscarHabitacionesLeftJoin("normal");
		for (Hotel f : lista3) {
			System.out.println("////////////////////");
			System.out.println(f);
		}
...
/////////////////////////////////////////////////
		...
		List<Hotel> lista4 = this.hotelService.buscarHabitacionesFullJoin("normal");
		for (Hotel f : lista4) {
			System.out.println("////////////////////");
			System.out.println(f);
		}
